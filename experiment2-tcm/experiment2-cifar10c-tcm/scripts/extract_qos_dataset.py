...
from tta_techniques.tent_adapter import LocalCIFAR10C, set_seed  # noqa: E402
from FL.train_fedavg_cifar10 import CIFAR10CNN  # noqa: E402
...
def build_common_sample_count(artifact_dirs: Sequence[Path], cifar10_c_root: Path) -> int:
    counts = []
...
def load_adapted_model(weights_path: Path) -> CIFAR10CNN:
...
def build_row(
    ...
    model = load_adapted_model(artifact_dir / "adapted_client_model.pt")
...
def main() -> None:
    ...
    parser.add_argument("--cifar10-c-root", default=str(PROJECT_ROOT / "Data" / "CIFAR-10-C"))
    ...
    common_sample_count = build_common_sample_count(artifact_dirs, cifar10_c_root)

    rows: List[Dict[str, object]] = []
    metadata: Dict[str, object] = {
        "artifacts_root": str(artifacts_root),
        "cifar10_c_root": str(cifar10_c_root),
        "common_sample_count": common_sample_count,
