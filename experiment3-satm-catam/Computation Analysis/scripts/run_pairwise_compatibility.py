...
def main():
    ...
    for adapted_case, adapted_info in adapted_static.items():
        ...
        for chunk_id, chunk_start, chunk_end in chunk_ranges(len(dataset), args.chunk_size):
            adapted_chunk_eval = chunk_metrics_from_outputs(adapted_outputs, chunk_start, chunk_end)
            for composition_name, composition_info in composition_static.items():
                ...
                composition_chunk_eval = chunk_metrics_from_outputs(composition_outputs, chunk_start, chunk_end)
                ...
                aggregated_accuracy = chunk_metrics_from_outputs(
                    aggregated_outputs, chunk_start, chunk_end
                )["accuracy"]
